...
public class Discard : MonoBehaviour
{
    ...
    [SerializeField] private float _cooldownBuffer = 0.5f; // extra time after spawn before accepting input
    ...
    public void OnDiscard()
    {
        ...
        DOVirtual.DelayedCall(_spawnDelay + _cooldownBuffer, () => IsOnCooldown = false);
    }
}